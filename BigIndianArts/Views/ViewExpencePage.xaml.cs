...
namespace BigIndianArts.Views
{
    ...
    public partial class ViewExpencePage : ContentPage
    {
        public ViewExpencePage()
        {
            InitializeComponent();
                ...
                else
                {
                    if (_apiresponse.IsSuccess == true)
                    {
                        ...
                        else
                        {
                            ...
                            var _expItem= _expenceModels.Where(x => x.Mode=="Expense");
        ...
        async private void Cv_selectionChanged(object sender, EventArgs e)
        {
            ...
            await Navigation.PushAsync(new EditExpencePage(_selectedBtn));
        }

        async private void CreateOrder_Tapped(object sender, EventArgs e)
        {
            await Navigation.PushAsync(new CreateExpencePage());
        }
